<?php
/**
 * The AHMEDxDARK extracts .zip or .rar archives and .gz files on webservers.
 ...
 * @version 0.1.1
 */
// Devloper file @Noahmed1
define('VERSION', '0.1.1');

$timestart = microtime(TRUE);
$GLOBALS['status'] = array();

$AHMEDxDARK = new AHMEDxDARK;
if (isset($_POST['dounzip'])) {
  // Check if an archive was selected for unzipping.
  $archive = isset($_POST['zipfile']) ? strip_tags($_POST['zipfile']) : '';
  $destination = isset($_POST['extpath']) ? strip_tags($_POST['extpath']) : '';
  $AHMEDxDARK->prepareExtraction($archive, $destination);
}
...
<html>
<head>
  <title>File AHMEDxDARK + Zipper</title>
...
<p class="version">AHMEDxDARK version: <?php echo VERSION; ?></p>
</body>
</html>
